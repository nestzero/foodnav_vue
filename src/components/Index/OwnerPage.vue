<template>
  ...
  <el-container class="home-container">
    ...
    <el-header>
     <!-- 管理员logo -->
      <span class="iconfont icon-meishi">美食向导网站</span>
      <!-- 导航 -->
      ...
      <el-main>
        <div>
          ...
          <el-breadcrumb separator-class="el-icon-arrow-right">
            <el-breadcrumb-item :to="{path:'/indexPage'}"><h2>首页</h2></el-breadcrumb-item>
          </el-breadcrumb>
          <!-- 商家主体部分 -->
          <el-card>
            ...
            <el-table :data="foodList" border stripe>
              ...
              <el-table-column>
                <template>
                    <!-- 进入该店家界面 -->
                    <el-button type="primary" class="iconfont icon-jinru" size="mini"></el-button>
                </template>
              </el-table-column>
            </el-table>
